...
const Card = ({ titleHeading, description, backgroundColor, borderRadius }: { image: string; titleHeading: string; description: string; backgroundColor?: string; borderRadius?: string }) => {
  return (
    <div className="max-w-[320px] mx-auto h-56 rounded overflow-hidden mt-20 shadow-lg dark:shadow-2xl dark:shadow-neutral-900" style={{ backgroundColor: backgroundColor, borderRadius: borderRadius }}>
      <div className="p-10">
        <div className={""} title="forHeadingTextCard">
