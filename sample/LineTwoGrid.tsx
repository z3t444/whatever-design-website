...
export default function LineTwoGrid() {
  return (
    <div className="grid items-center justify-center gap-5">
      <div className="dark:bg-gradient-to-br dark:from-[#1d1c20] dark:via-neutral-950 dark:to-black bg-gradient-to-br from-neutral-200 to-neutral-300 rounded-3xl w-[480px] p-7">
        ...
        {/* kit components */}
        <div className="mt-20 mb-20 mr-10 ml-10 flex items-start justify-center">
          <Switch></Switch>
