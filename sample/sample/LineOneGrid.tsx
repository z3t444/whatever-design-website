...
import RightIconsSearch from "../../app/Home/asset/RightIconsSearch";
  ...
  return (
    <>
      <div className="flex items-center mt-10 gap-5 rounded-3xl">
        <div className="dark:bg-gradient-to-br dark:from-[#1d1c20] dark:via-neutral-950 dark:to-black bg-gradient-to-br from-neutral-200 to-neutral-300 rounded-3xl max-w-[440px] p-7">
          ...
          <div className="mt-20 mb-32 mr-10 ml-10 flex items-center justify-center">
            <div className="relative search-animate flex items-center gap-2">
              <input type="text" placeholder="An app to book" className="max-w-60 pl-10 pr-16 py-3 rounded-full dark:bg-[#39393f] text-white focus:outline-none  placeholder-gray-400" />
